...
SWEP.Hook_TranslateAnimation = function(swep, anim)
    ...
    if anim == "inspect" then
        return anim .. math.Truncate(util.SharedRandom("hi", 0, 1.99)) .. (empty and "_empty" or "")
    end
end
...
SWEP.Animations = {
    ...
    ["ready"] = { Source = "ready", EventTable = { { s = "eft_shared/weap_in.wav", t = 0 }, } },
    ["holster"] = { Source = "holster", EventTable = { { s = "eft_shared/weap_out.wav", t = 0 }, } },

    ["draw_empty"] = { Source = "draw_empty", EventTable = { { s = "eft_shared/weap_in.wav", t = 0 }, } },
    ["ready_empty"] = { Source = "ready_empty", EventTable = { { s = "eft_shared/weap_in.wav", t = 0 }, } },
    ["holster_empty"] = { Source = "holster_empty", EventTable = { { s = "eft_shared/weap_out.wav", t = 0 }, } },
